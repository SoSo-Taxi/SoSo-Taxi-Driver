...
public class OrderNetService extends BaseNetService{
     ...
     */
    public static Pair<Boolean,String> rateForPassenger(long orderId, double rate) throws IOException, JSONException {

        // 构造URL
        StringBuffer urlBuffer=new StringBuffer();
        urlBuffer.append(Constant.RATE_FOR_PASSENGER_URL);
